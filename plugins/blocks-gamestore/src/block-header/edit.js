					...
					<div className="right-section">
						<div className="header-search">
							<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
								<g clip-path="url(#clip0_1294_4177)">
									<g filter="url(#filter0_d_1294_4177)">
										<path d="M28.29 27.66L23.61 22.95C26.97 19.2 26.7 13.44 22.95 10.05C19.2 6.66002 13.44 6.96002 10.05 10.71C6.66002 14.46 6.96002 20.22 10.71 23.61C14.19 26.76 19.5 26.76 22.98 23.61L27.69 28.32L28.29 27.66ZM16.83 25.05C12.3 25.05 8.61002 21.36 8.61002 16.83C8.61002 12.27 12.3 8.61002 16.83 8.61002C21.36 8.61002 25.05 12.3 25.05 16.83C25.05 21.36 21.36 25.05 16.83 25.05Z" fill="var(--action-main-svg, rgb(14, 13, 15))" fill-opacity="0.64"/>
										<path d="M16.8301 9.83984V10.7398C20.1901 10.7398 22.9201 13.4698 22.9201 16.8298H23.8201C23.8201 12.9598 20.7001 9.83984 16.8301 9.83984Z" fill="var(--action-main-svg, rgb(14, 13, 15))" fill-opacity="0.64"/>
									</g>
								</g>
								<defs>
									<filter id="filter0_d_1294_4177" x="3.69043" y="7.69043" width="28.5996" height="28.6294" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
										...
										<feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_1294_4177"/>
										<feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_1294_4177" result="shape"/>
									</filter>
									<clipPath id="clip0_1294_4177">
						...
						{cartLink &&
							<div className="header-cart-link">
								<a href={cartLink}>
									<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M7.71436 14.5718L9.42864 26.5718H26.5715L28.2858 14.5718" stroke="var(--action-main-svg, rgb(14, 13, 15))" stroke-opacity="0.64" stroke-linecap="round" stroke-linejoin="round"/>
										<path d="M12.8569 16.2859L14.5712 9.42871" stroke="var(--action-main-svg, rgb(14, 13, 15))" stroke-opacity="0.64" stroke-linecap="round" stroke-linejoin="round"/>
										<path d="M23.143 16.2859L21.4287 9.42871" stroke="var(--action-main-svg, rgb(14, 13, 15))" stroke-opacity="0.64" stroke-linecap="round" stroke-linejoin="round"/>
										<path d="M6 14.5718H30" stroke="var(--action-main-svg, rgb(14, 13, 15))" stroke-opacity="0.64" stroke-linecap="round" stroke-linejoin="round"/>
									</svg>
								</a>
							</div>
						}
